...
export default function ArchikHomes() {
  ...
  return (
    <section
      id="archik-homes"
      className="py-16 lg:py-24 bg-gradient-to-br from-amber-50 to-orange-100"
    >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-4xl mx-auto">
              From custom furniture manufacturing to complete interior
              solutions, Archik Homes transforms spaces into extraordinary
              experiences with bespoke designs tailored to your unique needs.
            </p>
          </div>
                  ...
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">
                        Custom furniture for homes and apartments
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm">
                        Durable solutions for industrial spaces
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center p-4 bg-white rounded-lg shadow-sm">
              ...
              <div className="flex space-x-6 w-max">
                {[
                  ...
                  },
                  {
                    ...
                    image:
                      "/design-mode/Designer-Bedroom-Furniture-UH-ROYAL-0016.jpg",
                  ...
                  },
                  {
                    ...
                    image:
                      "/design-mode/luxury-bedroom-with-furniture-premium-photo_124907-1084.jpg",
                    features: [
                      "Premium Suite",
                      "Complete Bedroom",
                      "Luxury Finish",
                  ...
                  <div
                    key={index}
                    className="flex-shrink-0 w-72 bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group"
                  >
                    ...
                    <div className="p-5">
                      ...
                      <div className="mb-4">
                        {product.features.slice(0, 2).map((feature, idx) => (
                          <span
                            key={idx}
                            className="inline-block bg-amber-100 text-amber-800 text-xs px-2 py-1 rounded mr-2 mb-1"
                          >
                            {feature}
                          </span>
                        ))}
          ...
          <div className="text-center mt-16">
            <div className="bg-white p-8 rounded-2xl shadow-lg max-w-2xl mx-auto">
              ...
              <p className="text-slate-600 mb-6">
                Discover our complete furniture and interior solutions designed
